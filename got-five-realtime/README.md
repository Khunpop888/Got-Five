...
- ระบบเสียงและผู้บรรยายภาษาไทยครบทั้งการคลิก เลือก จั่ว Categorise/Compare เปลี่ยนเทิร์น ทายผล อันดับรอบย่อย และอันดับรวม พร้อมปุ่มเปิด/ปิดที่จดจำค่า
...
4. ถ้าจะสร้างห้อง ให้เปิด `http://127.0.0.1:8787/owner` แล้วใส่รหัสใช้งาน
5. ตั้งรหัสห้องเองได้ เช่น `ไส้ตัน` หรือ `enjoy` แล้วกดสร้างห้อง
6. Copy invite link ส่งให้เพื่อน
...
หลังตั้งค่าแล้ว หน้าเว็บปกติจะเป็นหน้าเข้าห้องสำหรับเพื่อนเท่านั้น ถ้าคุณจะสร้างห้องให้เปิดหน้าเจ้าของ เช่น:

```text
https://your-site.onrender.com/owner
```

จากนั้นใส่รหัสใช้งาน แล้วตั้งรหัสห้องเองได้ เช่น `ไส้ตัน` หรือ `enjoy` เพื่อนที่ได้รับเชิญยังเข้าห้องจาก invite link หรือรหัสห้องได้ตามปกติ และถ้าเกมเริ่มแล้วผู้เล่นใหม่จะเข้าไม่ได้
