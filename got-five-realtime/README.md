...
4. ถ้าจะสร้างห้อง ให้เปิด `http://127.0.0.1:8787/?owner=1` แล้วใส่รหัสใช้งาน
...
หลังตั้งค่าแล้ว หน้าเว็บปกติจะเป็นหน้าเข้าห้องสำหรับเพื่อนเท่านั้น ถ้าคุณจะสร้างห้องให้เปิด URL พร้อม `?owner=1` เช่น:

```text
https://your-site.onrender.com/?owner=1
```
